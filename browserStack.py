...
def get_cache_path(browser_type, username):
    if(browser_type == 'chrome'):
        return "/home/"+ username +"/.config/google-chrome"
    elif(browser_type == 'firefox'):
...
def get_browser_instance():
    ...
    cmd_open = get_browser(browser_type) + " " + url
    os.system(cmd_open)
...
def clear_browser():
    ...
    uname = "user name"
    remove_cmd = "rm -rfv " + get_cache_path(browser_type, uname)
